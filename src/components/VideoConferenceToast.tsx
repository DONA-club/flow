...
export const VideoConferenceToast: React.FC<Props> = ({ link, platform, onClose }) => {
  ...
  return (
    <div className="relative group w-auto inline-block">
      ...
      {/* Contenu */}
      <div className="relative px-5 py-3 rounded-2xl border border-white/20 shadow-2xl">
        <a
          href={link}
          target="_blank"
        ...
        >
          ...
          <div className="flex flex-col">
            <div className="text-white font-semibold text-sm tracking-tight group-hover/link:text-blue-100 transition-colors">
              Connectez-vous
            </div>
